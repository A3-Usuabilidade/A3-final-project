      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 id="modal-confirmacao-titulo" className="text-lg font-semibold text-on-surface">{titulo}</h3>
          </div>
          <button onClick={onCancelar} aria-label="Fechar modal" className="text-on-surface-variant hover:text-on-surface cursor-pointer">
            <X size={18} aria-hidden="true" />
          </button>
        </div>

        <p id="modal-confirmacao-texto" className="text-on-surface-variant text-sm mb-6">{mensagem}</p>
